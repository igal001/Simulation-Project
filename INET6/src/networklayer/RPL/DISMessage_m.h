...
#ifndef _DISMESSAGE_M_H_
#define _DISMESSAGE_M_H_
...
/**
 * Class generated from <tt>networklayer/RPL/DISMessage.msg</tt> by opp_msgc.
 * <pre>
 * packet DISMessage {
 *     int someField;
 *     string anotherField;
 ...
 * </pre>
 */
class DISMessage : public ::cPacket
{
  protected:
    int someField_var;
    ...
    bool operator==(const DISMessage&);

  public:
    DISMessage(const char *name=NULL, int kind=0);
    DISMessage(const DISMessage& other);
    virtual ~DISMessage();
    DISMessage& operator=(const DISMessage& other);
    virtual DISMessage *dup() const {return new DISMessage(*this);}
...
inline void doPacking(cCommBuffer *b, DISMessage& obj) {obj.parsimPack(b);}
inline void doUnpacking(cCommBuffer *b, DISMessage& obj) {obj.parsimUnpack(b);}


#endif // _DISMESSAGE_M_H_
