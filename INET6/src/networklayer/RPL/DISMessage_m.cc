//
// Generated file, do not edit! Created by opp_msgc 4.1 from networklayer/RPL/DISMessage.msg.
//
...
Register_Class(DISMessage);

DISMessage::DISMessage(const char *name, int kind) : cPacket(name,kind)
{
...
DISMessage::DISMessage(const DISMessage& other) : cPacket()
{
...
DISMessage& DISMessage::operator=(const DISMessage& other)
{
...
void DISMessage::parsimPack(cCommBuffer *b)
{
...
void DISMessage::parsimUnpack(cCommBuffer *b)
{
...
int DISMessage::getSomeField() const
{
    return someField_var;
}

void DISMessage::setSomeField(int someField_var)
{
    this->someField_var = someField_var;
}

const char * DISMessage::getAnotherField() const
{
    return anotherField_var.c_str();
}

void DISMessage::setAnotherField(const char * anotherField_var)
{
    this->anotherField_var = anotherField_var;
}

void DISMessage::setArrayField1ArraySize(unsigned int size)
{
...
unsigned int DISMessage::getArrayField1ArraySize() const
{
    return arrayField1_arraysize;
}

double DISMessage::getArrayField1(unsigned int k) const
{
...
void DISMessage::setArrayField1(unsigned int k, double arrayField1_var)
{
    if (k>=arrayField1_arraysize) throw cRuntimeError("Array of size %d indexed by %d", arrayField1_arraysize, k);
    this->arrayField1_var[k]=arrayField1_var;
}

unsigned int DISMessage::getArrayField2ArraySize() const
{
    return 10;
}

double DISMessage::getArrayField2(unsigned int k) const
{
    if (k>=10) throw cRuntimeError("Array of size 10 indexed by %lu", (unsigned long)k);
    return arrayField2_var[k];
}

void DISMessage::setArrayField2(unsigned int k, double arrayField2_var)
{
    if (k>=10) throw cRuntimeError("Array of size 10 indexed by %lu", (unsigned long)k);
    this->arrayField2_var[k] = arrayField2_var;
}

class DISMessageDescriptor : public cClassDescriptor
{
  public:
    DISMessageDescriptor();
    virtual ~DISMessageDescriptor();
...
Register_ClassDescriptor(DISMessageDescriptor);

DISMessageDescriptor::DISMessageDescriptor() : cClassDescriptor("DISMessage", "cPacket")
{
}

DISMessageDescriptor::~DISMessageDescriptor()
{
}

bool DISMessageDescriptor::doesSupport(cObject *obj) const
{
    return dynamic_cast<DISMessage *>(obj)!=NULL;
}

const char *DISMessageDescriptor::getProperty(const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? basedesc->getProperty(propertyname) : NULL;
}

int DISMessageDescriptor::getFieldCount(void *object) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 4+basedesc->getFieldCount(object) : 4;
}

unsigned int DISMessageDescriptor::getFieldTypeFlags(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
...
const char *DISMessageDescriptor::getFieldName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int DISMessageDescriptor::findField(void *object, const char *fieldName) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
...
const char *DISMessageDescriptor::getFieldTypeString(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *DISMessageDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int DISMessageDescriptor::getArraySize(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    DISMessage *pp = (DISMessage *)object; (void)pp;
    switch (field) {
...
std::string DISMessageDescriptor::getFieldAsString(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
bool DISMessageDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *DISMessageDescriptor::getFieldStructName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
void *DISMessageDescriptor::getFieldStructPointer(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
