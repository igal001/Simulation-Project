...
class INET_API ICMPv6 : public cSimpleModule
{
  ...
  protected:
    ...
    /**
     * Processing RPL Control messages that arrive in this module.
     */
    virtual void processRPLcontrol(ICMPv6RPLControl *icmpv6msg);

    /**
     * Forward the RPL control message to the IP.
     */
    virtual void sendRPLControl(cPacket *msg);
};
